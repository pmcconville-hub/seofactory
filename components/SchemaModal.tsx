  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex justify-center items-center p-4" onClick={onClose}>
      <Card className="w-full max-w-4xl max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
        {/* Header */}
        <header className="sticky top-0 bg-gray-800 p-4 border-b border-gray-700 z-10 flex-shrink-0">
        ...
        {/* Footer */}
        <footer className="p-4 bg-gray-800 border-t border-gray-700 flex justify-between">
          <div>
            {onRegenerate && (
              <Button
